...
<body>
        ...
        <div class="navbar-nav flex-row order-md-last">
          ...
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
              <a href="./profile.html" class="dropdown-item">Cá nhân</a>
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
          <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/giftcodes">
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
            ...
            <div class="col-12 col-lg-auto mt-3 mt-lg-0">
              <ul class="list-inline list-inline-dots mb-0">
                <li class="list-inline-item">
                  Copyright &copy; 2024
                  <a href="." class="link-secondary">Tru Tiên Thần Long</a>.
                  All rights reserved.
                </li>
              </ul>
            </div>
  ...
  <!-- Libs JS -->
  <script src="/ui/dist/libs/apexcharts/dist/apexcharts.min.js?1692870487" defer></script>
  <script src="/ui/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1692870487" defer></script>
  <script src="/ui/dist/libs/jsvectormap/dist/maps/world.js?1692870487" defer></script>
  <script src="/ui/dist/libs/jsvectormap/dist/maps/world-merc.js?1692870487" defer></script>
  <!-- Tabler Core -->
